...
#include "MAX30105.h" //Biblioteca del sensor MAX30100 y familia
#include "spo2_algorithm.h" //Biblioteca para el calculo de la oxigenacion
#include <Adafruit_MLX90614.h> //Biblioteca del sensor de temperatura IR
...
void loop() {
  ...
  //Fin de lectura del sensor MAX30100

  //Inicia lectura sensor Temperatura IR
  ...
  //Fin lectura sensor Temperatura IR
  ...
  if (timeNow - timeLast > wait) { // Manda un mensaje por MQTT cada cinco segundos
    ...
    String cadenaValores = "{\"id\":\"Ramses Ortiz\",\"hrv\":"+String(heartRate)+",\"Spo2\":"+String(spo2)+",\"temp\":"+String(dataString)+"}";
    ...
    client.publish("codigoIoT/detectorSintomas/esp", char_array); // Esta es la función que envía los datos por MQTT, especifica el tema y el valor
